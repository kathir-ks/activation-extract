...
def parse_args():
    ...
    train.add_argument("--dead_neuron_resample_until", type=int, default=0,
                        help="Stop resampling after this step (0=never stop)")
    ...
    dist.add_argument("--barrier_num_workers", type=int, default=None,
                      help="Number of workers for barrier sync (auto-detect if not set)")
...
def main():
    ...
    if args.enable_barrier_sync:
        ...
        num_workers = args.barrier_num_workers or get_num_workers()
    ...
    if args.preset:
        ...
        train_config = TrainingConfig(
            ...
            dead_neuron_resample_until=args.dead_neuron_resample_until,
